                    ...
                    <div class="col-3">
                        <form action="{{route('book.show_book',$book->id)}}" method="get">
                            <select name="sort" id="sort" class="form-select w-100" onchange="this.form.submit()">
                                ...
                                <option value="latest-arrives" {{ request('sort') == 'latest-arrives' ? 'selected' : '' }}>Latest-arrives</option>
                                <option value="highest-rating" {{ request('sort') == 'highest-rating' ? 'selected' : '' }}>Highest Rating</option>
                                <option value="lowest-rating" {{ request('sort') == 'lowest-rating' ? 'selected' : '' }}>Lowest Rating</option>
                            </select>
                        </form>
                    </div>
