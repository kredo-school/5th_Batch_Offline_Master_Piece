...
@section('content')
    <a href="{{ route('store.inventory') }}" class="fw-bold text-decoration-none main-text btn border-0">
    ...
    <form action="{{ route('store.addOrUpdateOrders') }}" method="post" class="d-flex flex-column">
        @csrf
        @method('PATCH')
